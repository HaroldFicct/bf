            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Sistema Bilbiotecario</span>
                </a>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('categorias') }}" class="{{ Request::path() === 'categorias' ? 'nav-link active' : 'nav-link' }}">
                                    ...
                                    <p>
                                        ...
                                        <span class="right badge badge-danger">{{ $categoriascantidad ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="carreras"
                                    ...
                                    <p>
                                        Carreras 
                                        <?php $carrerascantidad = DB::table('carreras')->count(); ?>
                                        
                                        <span class="right badge badge-danger">{{ $carrerascantidad ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
                            @endcan
